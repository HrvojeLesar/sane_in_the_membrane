    ...
    class CStartupOrchestrator {
      public:
        ...
        void wait() {
            ...
            log::trace("CStartupOrchestrator waiting for threads");
      ...
      private:
        ...
        struct SStdinWorker {
            ...
            void operator()() {
                ...
                log::info("Shut down stdin worker");
            }
        ...
        struct SAvahiServiceWorker {
            ...
            void operator()() {
                ...
                log::info("Shut down avahi service registration");
            }
