...
void CScannerSelect::display_items(const utils::SharedAccessGuard<std::vector<std::shared_ptr<service::CScannerItem>>>& items) {
    clear();
...
std::shared_ptr<sane_in_the_membrane::service::CScannerItem> CScannerSelect::currentData(int role) const {
